...
> **Note:** Since this is the organization-wide `.github` repository, the guidelines here apply broadly to **all our repositories**. Each specific repository might have its own additional `CONTRIBUTING.md` with more technical or language-specific guidelines.
...
- **Clear Title:** Use a clear and descriptive title for the issue.
- **Reproduce Steps:** Describe the exact steps which reproduce the problem.
...
1. **Fork** the specific repo you want to contribute to and create your branch from `main`.
2. **Follow Guidelines:** Ensure your code follows the existing style and architecture of that specific project.
3. **Update Docs:** Update the documentation if you've changed APIs or added new features.
4. **Descriptive Commits:** Ensure your commit messages are descriptive and clear.
5. **Submit:** Open that pull request!
...
- **Naming Conventions:** Follow the naming conventions established in the project you're modifying.
- **Optimization:** Optimize for both performance and readability.
